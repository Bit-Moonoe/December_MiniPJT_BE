...
const SignIn = () => {
    ...
    const login = async (event) => {
        ...
        await axios.post("http://localhost:3040/user/sign-in", req)
            ...
            .catch((err) => {
                ...
                // alert(err.response.data.message); 스프링에서 작업해줄것

                const res = err.response;
                if (res.status == 500 || res.status == 400) { //원래는 400
    ...
    return (
        <div className="w-full overflow-scroll h-screen bg-gradient-to-r from-blue-100 via-purple-100 to-pink-100 p-4 flex items-center justify-center">
            <div className="w-full my-2 md:w-3/5 lg:w-2/5">
                ...
                <div className="flex justify-center items-center mt-10 mb-20">
                    <svg version="1.1" id="Capa_2" width="100px" height="100px" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 480 480" style={{ enableBackground: 'new 0 0 480 480' }} xmlSpace="preserve">
        ...
        C464,288.704,448.328,333.792,421.832,370.584z" />
                ...
                <div className="bg-white py-6 px-10 md:pl-8 rounded-2xl">
                    <div className="flex my-8 mx-4 md:mx-2 border-b-2 border-gray-700 hover:border-green-800">
                        <label className="self-center w-20" >Nickname:</label>
                        <input className="w-full py-3 pl-2 md:pl-6 border-0 focus:outline-none" type="text" name="nickName" placeholder="닉네임을 입력해주세요" onChange={ChangeNickName} autoComplete="on" required />
                    </div>
                    <div className="flex my-8 mx-4 md:mx-2 border-b-2 border-gray-700 hover:border-green-800">
                        <label className="self-center w-20">Password:</label>
                        <input className="w-full py-3 pl-2 md:pl-8 border-0 focus:outline-none" type="text" name="pwd" placeholder="비밀번호를 입력해주세요" onChange={ChangePwd} required />
                    </div>
                </div>
                <div className='pt-[13px]'>
                    <button className='w-full rounded-full p-2 md:pl-8 border-y-4 focus:outline-none bg-gradient-to-r from-sky-600  to-teal-300 text-white text-lg font-semibold'
                        type="submit"
                        onClick={login}>
                        로그인
                    </button>
